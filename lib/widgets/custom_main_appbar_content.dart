...
class _CustomMainAppBarContentState extends State<CustomMainAppBarContent> {
  ...
  //   _movieCards = await movieModel.getUserMenu(movieID: 5, year: '');

  //   setState(() {
  //     print("******************************************************");
  //     print(_movieCards.obs);
  //     print("******************************************************");
  //   });
  // }
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //       print("\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
                    //       print(widget.videoTypes![1].title);
                    //     });
                    //   },
                    //   color: widget._firstColor,
                    // ),
                    for (int x = 0;
                        x <= widget.videoTypes!.length - 1;
                        x++) ...[
                      CustomMoviesButton(
                        text: widget.videoTypes![x].title,
                        onPressed: () {
                          setState(() {
                            widget
                                .buttonFistOnPressed!(widget.videoTypes![x].id);
                          });
                        },
                        color: widget._firstColor,
                      ),
